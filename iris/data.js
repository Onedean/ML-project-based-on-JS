 ...
 */
function convertToTensors(data, targets, testSplit) {  // 将数据集转换为tensor
 ...
 *     {0, 1, 2}.
 */
export function getIrisData(testSplit) {  // 分割验证集和训练集
    return tf.tidy(() => {
        const dataByClass = [];
